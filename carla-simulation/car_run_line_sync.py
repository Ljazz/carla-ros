...
"""
 ...
 LastEditors    : xiaoming.ma
 LastEditTime   : 2022-06-28 12:29:31
...
def main():
    ...
    try:
        ...
        print(main_vehicle_spawn_point)
        my_vehicle = world.spawn_actor(vehicle_bp, main_vehicle_spawn_point)
        test_vehicle = world.try_spawn_actor(
            test_vehicle_bp, test_vehicle_spawn_point)
        ...
        import math
        print("车速 ==> ", 3.6 * math.sqrt(vel.x**2 + vel.y**2 + vel.z**2))
        print("localtion", my_vehicle.get_location())
