...
def importMyAssets():
    texture_task = buildImportTask(texture_jpg, "/Game/MyAsset/Texture")
    sound_task = buildImportTask(sound_mp3, "/Game/MyAsset/Sounds")
...
if __name__ == '__main__':
    asset_folder = "D:/CARLA/workspace/images"
    texture_jpg = os.path.join(asset_folder, "1.jpg").replace("\\", "/")
